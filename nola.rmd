...
We took off at 8pm, so it was already dark out. The day/night map does not include this route, but it looks like it will be dark through Illinois and Kentucky, but we should see Memphis when we wake up. 
